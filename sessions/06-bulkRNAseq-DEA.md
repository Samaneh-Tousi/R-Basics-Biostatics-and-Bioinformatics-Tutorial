...
**Download the input count matrix here:**  
[Download `featureCounts_counts_matrix.tsv`](assets/featureCounts_counts_matrix.tsv)

This tutorial uses a clean gene-level count matrix produced by **featureCounts**.  
The matrix file should be placed in the repository `assets/` folder:
...
| **Others** | Varies | Varies | Useful in special cases | Less standard for typical bulk RNA-seq | Specialized workflows |
...
This method calculates a **size factor** for each sample.  
The size factor corrects for differences in sequencing depth so that samples can be fairly compared.
...
Geometric mean = cube root of 10 × 20 × 5 ≈ 10
```
...
## Step 2: Compare Each Sample to This Reference
...
This adjusts samples with different sequencing depths to the same scale.

This method corrects sequencing depth without being strongly distorted by highly expressed genes.  
It assumes that most genes do not change dramatically between samples.

---

# Existing Example Figures

This tutorial also refers to example plots already available in the repository `assets/` folder:

```text
assets/Disp_plot.png
assets/MAplot.png
assets/PCAplot.png
assets/DEGs_Volcano.png
assets/GSEA.png
```

These images are included below in the relevant analysis sections.
...
# 14. VST Transformation and PCA Plot
...
# 19. Identify Differentially Expressed Genes
...
# 20. p-value, Adjusted p-value, and FDR
...
# 22. What log2 Fold Change Means
...
# 23. Heatmap of Most Variable Genes
...
# 25. edgeR Differential Expression Analysis
...
# 26. Filter Low-Expression Genes in edgeR
...
# 30. Estimate Dispersion with edgeR
...
# 37. Prepare Gene Lists for Enrichment Analysis
...
# 38. GO Enrichment with clusterProfiler
...
# 39. KEGG Enrichment with clusterProfiler
...
# 42. Prepare Ranked Gene List for GSEA
...
# 43. GSEA with Hallmark Pathways
...
# 48. Automatically Visualize the Top Enriched KEGG Pathway
...
4. Ran DESeq2
5. Visualized dispersion, MA plot, PCA plot, and volcano plot
6. Identified DEGs
7. Created DEG and variable-gene heatmaps
8. Ran edgeR
9. Compared edgeR and DESeq2
10. Performed GO and KEGG enrichment with clusterProfiler
11. Performed Enrichr analysis
12. Performed GSEA
13. Visualized KEGG signaling pathways using pathview
