...
Create a new R script in RStudio to complete the following exercises. Save the script in the r_project folder you created during the first session and name the file practice_00_01.R.
